...
+(NSDictionary*)getToken:(NSString*)key projectId:(NSString*)pid uid:(NSString*)uid{
    ...
    NSString * secert = [RTMTokenTest base64DecodingString:key];
    ...
    NSData * h256Data_step2 = [RTMTokenTest hmacSHA256WithSecret:secert content:source_step1];
